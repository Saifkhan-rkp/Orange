...
import 'package:wordle/service/background_service.dart';   // ← added
...
Future<void> main() async {
  ...
  // Start the foreground service (and therefore the Socket.IO connection)
  // before the UI is built. startService() is a no-op if already running → single instance.
...
class _MyAppState extends State<MyApp> {
  // SocketService is now owned exclusively by the background service.
  ...
  void initState() {
    super.initState();
    //loadSettings();
    // Socket init removed – handled by the background service.
...
// … remainder of the file (HomePage, OfflinePage, etc.) stays unchanged …
